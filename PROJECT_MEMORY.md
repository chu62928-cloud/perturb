...
- 2026-09-06T19:10+08:00: 提交`0339ee5`完善正式HVG映射、检测率审计、D2批流和`d2-train`入口；提交`9c930a5`加强迁移报告目标哈希/重叠断言并加入批流合成数据测试。远端测试为37项通过、1项因e3_pipeline无PyTorch跳过；两次提交均已推送到唯一分支`d2-state-single-step`。
